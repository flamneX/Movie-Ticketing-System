<nav id="topNavigation">
    <ul>
        ...
        <li><a id="profile" href="/Movie-Ticketing-System/userAuthentication/"><button style="background-image:linear-gradient(to bottom right, #A76BCE, #7F00FF);">SIGN IN</button></a></li>
    </ul>
    <script>
